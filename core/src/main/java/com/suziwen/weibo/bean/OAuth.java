 ...
 * ******************************************************
 * <p>
 * Description:OAuth认证参数实体类
 * </p>
 * <p>
 * Create Time: 2012-3-27 下午05:04:37
 * </p>
 * <p>
 ...
 */
public class OAuth {
	private String oauth_consumer_key = "";// AppKey(client
													// credentials)
	...
	private String oauth_version = "1.0";// (可选)认证方式版本
	...
	private String user_id = "";//各个微博对应的唯一 号,username,uuid等
	private String requestTokenUrl = "";//requesttoken需要的url
	private String oauthTokenUrl = ""; //userAuthToken需要的url
	private String accessTokenUrl = ""; //accessTokenUrl需要的url
