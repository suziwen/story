 ...
 */
$.alert = $.dialogx.alert = function (content, callback) {
    return $.dialogx({
        id: 'Alert',
        fixed: true,
        lock: true,
 ...
 */
$.confirm = $.dialogx.confirm = function (content, ok, cancel) {
    return $.dialogx({
        id: 'Confirm',
        fixed: true,
        lock: true,
 ...
 */
$.prompt = $.dialogx.prompt = function (content, ok, defaultValue) {
...
/** 抖动效果 */
$.dialogx.prototype.shake = (function () {
