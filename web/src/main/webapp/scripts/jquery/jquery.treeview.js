                ...
                case "locationparam":
                    var current = this.find("a").filter(function() {
                        if (this.href.toLowerCase() == location.href.toLowerCase()) {
                            ...
                            var ahref = $.url(this.href.toLowerCase());
                            var lhref = $.url(location.href.toLowerCase());
                            if (!!settings.locationparam) {
                                if (ahref.attr(path) == lhref.attr(path) && ahref.param(settings.locationparam) == lhref.param(settings.locationparam)) {
                                    return true;
                                }
                            } else {
                                if (ahref.attr('path') == lhref.attr('path')) {
                                    return true;
                                }
                            }
                        }
